...
try {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $error_message = "Customer data not found.";
    }
} catch (Exception $e) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
        ...
        if (password_verify($current_password, $customer_data['password']) || $current_password === $customer_data['password']) {
            // Hash new password
...
<head>
    ...
    <title>My Profile - Mega Book Store</title>
        ...
        <main class="main-content" id="mainContent">
            ...
            <header class="top-nav">
                ...
                <div class="user-menu">
                    ...
                    <div class="user-info">
                        <span><?php echo htmlspecialchars($customer_data['fullname']); ?></span>
                        <img src="asset/profile.png" alt="Customer">
                ...
                <div class="profile-container">
                    ...
                    <div class="profile-sidebar">
                        <div class="profile-image">
                            <img src="asset/profile.png" alt="Customer Profile">
                        </div>
                        <div class="profile-info">
                            <h2><?php echo htmlspecialchars($customer_data['fullname']); ?></h2>
                            <p><?php echo htmlspecialchars($customer_data['email']); ?></p>
                            <div class="profile-badge">Customer</div>
                        </div>
                        <div class="profile-stats">
                            <div class="stat-item">
                                <h3>Joined</h3>
                                <p><?php echo date('M d, Y', strtotime($customer_data['created_at'])); ?></p>
                            </div>
                            <div class="stat-item">
                                <h3>Orders</h3>
                    ...
                    <div class="profile-content">
                        ...
                        <div class="profile-card">
                            ...
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($customer_data['phone'] ?? ''); ?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="address" class="required-field">Address</label>
                                    <textarea id="address" name="address" rows="3" required><?php echo htmlspecialchars($customer_data['address'] ?? ''); ?></textarea>
                                </div>
                        ...
                        <div class="profile-card">
                            ...
                            <?php if ($order_count > 0): ?>
                                <p>You have placed <?php echo $order_count; ?> orders. <a href="orders.php" style="color: #3498db;">View your order history</a>.</p>
                            <?php else: ?>
                                <p>You haven't placed any orders yet. <a href="books.php" style="color: #3498db;">Browse books</a> to start shopping.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
