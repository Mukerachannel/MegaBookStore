...
if (isset($_GET['action']) && $_GET['action'] === 'delete' && isset($_GET['id'])) {
  ...
  if ($result && $result->num_rows > 0) {
      ...
      if ($user['role'] === 'seller') {
          ...
          if ($stmt->execute()) {
              $success_message = "Seller has been deleted successfully.";
          } else {
              $error_message = "Error deleting seller: " . $stmt->error;
          }
      } else {
          $error_message = "Selected user is not a seller.";
      }
  } else {
...
<head>
    ...
    <title>Manage Sellers - Mega Book Store</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="dashboard.css">
    <style>
        /* Manage Sellers specific styles */
        .dashboard-content {
            padding: 20px;
        }
        ...
        <main class="main-content" id="mainContent">
            ...
            <header class="top-nav">
                ...
                <div class="user-menu">
                    <div class="user-info">
                        <span>Manager</span>
                        <a href="manager_profile.php"><img src="asset/profile.png" alt="Manager"></a>
                    </div>
                </div>
            </header>
            ...
            <div class="dashboard-content">
                <div class="section-header">
                    ...
                    <div>
                        <a href="approve_sellers.php" class="btn-action" style="background-color: #2ecc71;">Approve New Sellers</a>
                ...
                <?php if ($user_details): ?>
                    ...
                    <div class="user-details-card">
                        <div class="user-details-header">
                            ...
                            <a href="manage_sellers.php" class="btn-action btn-back">Back to List</a>
                        </div>
                        ...
                        <div class="user-actions">
                            <a href="manage_sellers.php?action=delete&id=<?php echo $user_details['id']; ?>" class="btn-action btn-delete-lg" onclick="return confirm('Are you sure you want to delete this seller?')">
                                Delete Seller
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="table-container">
                        <table class="data-table">
                            ...
                            <tbody>
                                <?php if (count($sellers) > 0): ?>
                                    <?php foreach ($sellers as $seller): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-<?php echo strtolower($seller['status']); ?>">
                                            ...
                                            <td class="actions">
                                                ...
                                                <a href="manage_sellers.php?action=delete&id=<?php echo $seller['id']; ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete this seller?')">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="7" style="text-align: center;">No sellers found</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
